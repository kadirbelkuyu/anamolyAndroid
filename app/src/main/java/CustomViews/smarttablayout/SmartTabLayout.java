 ...
 */
package CustomViews.smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textHorizontalMargin = (int) (TAB_VIEW_PADDING_DIPS * density);
        int textElevation = 0;
        ...
        textHorizontalMargin = a.getDimensionPixelSize(
                R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalMargin, textHorizontalPadding);
        textElevation = a.getDimensionPixelSize(
                R.styleable.stl_SmartTabLayout_stl_defaultTabElevation, textElevation);
        ...
        this.tabViewTextHorizontalMargin = textHorizontalMargin;
        this.tabViewElevation = textElevation;
    ...
    public void setDefaultTabBackground(StateListDrawable colors) {
        tabViewBackground = colors;
    }
    ...
    protected TextView createDefaultTabView(CharSequence title) {
        ...
        Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "fonts/Tajawal-Bold.ttf");
        textView.setTypeface(tf);
        //textView.setTypeface(Typeface.DEFAULT_BOLD);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT);
        params.setMargins(tabViewTextHorizontalMargin, tabViewElevation / 2, tabViewTextHorizontalMargin, tabViewElevation / 2);
        textView.setLayoutParams(params);

        //if (tabViewBackground != null) {
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setCornerRadius(CommonActivity.dpToPx(getContext(), 5F));
        gradientDrawable.setColor(CommonActivity.getHeaderColor());

        GradientDrawable gradientDrawableNormal = new GradientDrawable();
        gradientDrawableNormal.setCornerRadius(CommonActivity.dpToPx(getContext(), 5F));
        gradientDrawableNormal.setColor(ContextCompat.getColor(getContext(), R.color.colorWhite));

        StateListDrawable res = new StateListDrawable();
        res.addState(new int[]{android.R.attr.state_selected}, gradientDrawable);
        res.addState(new int[]{}, gradientDrawableNormal);

        textView.setBackground(res);
        /*} else if (tabViewBackgroundResId != NO_ID) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabView.setElevation(tabViewElevation);
