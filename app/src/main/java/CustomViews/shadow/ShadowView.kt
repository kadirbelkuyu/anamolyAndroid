...
open class ShadowView @JvmOverloads constructor(context: Context?, attributeSet: AttributeSet? = null, defStyleInt: Int = 0)
    ...
    init {
        ...
        if (shadowMargin >= 0) {
            ...
            if (isRTL(Locale.getDefault())) {
                ...
                shadowMarginRight = a.getDimensionPixelSize(R.styleable.ShadowView_shadowMarginLeft, SIZE_DEFAULT)
                shadowMarginLeft = a.getDimensionPixelSize(R.styleable.ShadowView_shadowMarginRight, SIZE_DEFAULT)
        ...
        if (cornerRadius >= 0) {
            ...
            if (isRTL(Locale.getDefault())) {
                cornerRadiusTR = a.getDimensionPixelSize(R.styleable.ShadowView_cornerRadiusTL, SIZE_DEFAULT).toFloat()
                cornerRadiusTL = a.getDimensionPixelSize(R.styleable.ShadowView_cornerRadiusTR, SIZE_DEFAULT).toFloat()
                cornerRadiusBR = a.getDimensionPixelSize(R.styleable.ShadowView_cornerRadiusBL, SIZE_DEFAULT).toFloat()
                cornerRadiusBL = a.getDimensionPixelSize(R.styleable.ShadowView_cornerRadiusBR, SIZE_DEFAULT).toFloat()
            } else {
    ...
    fun isRTL(locale: Locale): Boolean {
        val directionality = Character.getDirectionality(locale.getDisplayName()[0]).toInt()
