...
class TextViewBold : TextView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            val a = context.theme.obtainStyledAttributes(attrs, R.styleable.TextViewBold, 0, 0)

            if (a.getBoolean(R.styleable.TextViewBold_allowBG, false)) {
                val gradientDrawable = GradientDrawable()
                gradientDrawable.cornerRadius =
                    a.getDimension(R.styleable.TextViewBold_cornerRadius, 5F)
