...
public class AppBarLayoutSpringBehaviorWithoutNestedScrollTouch extends AppBarLayout.Behavior {
    ...
    public AppBarLayoutSpringBehaviorWithoutNestedScrollTouch() {
    }

    public AppBarLayoutSpringBehaviorWithoutNestedScrollTouch(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void animateFlingSpring(final CoordinatorLayout coordinatorLayout, final AppBarLayout abl, int originNew) {
        if (mFlingAnimator == null) {
            ...
            mFlingAnimator.setDuration(100);
    ...
    private void animateRecoverBySpring(final CoordinatorLayout coordinatorLayout, final AppBarLayout abl) {
        if (mSpringRecoverAnimator == null) {
            ...
            mSpringRecoverAnimator.setDuration(100);
    ...
    private void updateSpringHeaderHeight(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int offset) {
        ...
        if (allowFullTouchZoom) {
            layoutParams.height = mPreHeadHeight + offset;
        } else {
            layoutParams.height = mPreHeadHeight + ((enableSpring) ? offset : 0);
        }
    ...
    private boolean allowFullTouchZoom = false;

    public void allowFullTouchZoom(boolean allowFullTouchZoom) {
        this.allowFullTouchZoom = allowFullTouchZoom;
    }
